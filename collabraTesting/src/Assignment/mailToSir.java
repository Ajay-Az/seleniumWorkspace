...
public class mailToSir {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("login1")).sendKeys("ajayzen11@rediffmail.com");
		driver.findElement(By.id("password")).sendKeys("907108842@aA");
		driver.findElement(By.name("proceed")).click();
		
		driver.findElement(By.xpath("//b[text() = 'Write mail']")).click();
		driver.findElement(By.id("TO_IDcmp2")).sendKeys("ajayzen11@rediffmail.com");
		driver.findElement(By.xpath("//input[@class=\"rd_inp_sub rd_subject_datacmp2\"]")).sendKeys("Ajay.A");
		Thread.sleep(2000);
		...
		refershButtonicon.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@subject=\"Ajay.A\"]")).click();
